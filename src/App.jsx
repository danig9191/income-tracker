...
<style>{`@import url('https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600&family=DM+Mono:wght@400;500&family=Bebas+Neue&display=swap'); * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; } .mode-pill { background: none; border: none; color: #555; padding: 7px 0; border-radius: 18px; cursor: pointer; font-family: 'DM Sans', sans-serif; font-size: 12px; font-weight: 500; transition: all 0.18s; flex: 1; text-align: center; } .mode-pill.active { background: #00e5a0; color: #080808; font-weight: 700; border-radius: 16px; } .txn-row { display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; border-bottom: 1px solid #111; transition: background 0.1s; } .txn-row:last-child { border-bottom: none; } .txn-row:active { background: #0f0f0f; } .x-btn { width: 30px; height: 30px; border-radius: 50%; border: 1px solid #1e1e1e; background: none; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.15s; flex-shrink: 0; touch-action: manipulation; } .x-btn:active { background: #1a1a1a; transform: scale(0.92); } @keyframes fadeUp { from { opacity: 0; transform: translateY(8px); } to { opacity: 1; transform: translateY(0); } } .chart-anim { animation: fadeUp 0.3s ease both; }`}</style>
